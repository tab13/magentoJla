...
class Magestore_Webpos_Model_Source_Adminhtml_Multipaymentforpos {
    ...
    public function __construct() {
        $this->_allowPayments = array('cashforpos', 'pendingforpos', 'ccforpos', 'codforpos', 'cp1forpos', 'cp2forpos'); // CUSTOMIZE pending payment US15,16
        $this->_allowPaymentsWithLabel = array(
            'cashforpos' => Mage::helper('webpos/payment')->getCashMethodTitle(),
            'pendingforpos' => Mage::helper('webpos/payment')->getPendingMethodTitle(), // CUSTOMIZE pending payment US15,16
