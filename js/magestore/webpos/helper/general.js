...
define([
    ...
    var Helper = {
        ...
        isShippingPriceIncludesTax: function () {
            return (window.webposConfig['tax/calculation/shipping_includes_tax'] == '1') ? true : false;
        },
            ...
            if (type) {
                ...
                switch (type) {
                    ...
                    case 'subtotal':
                        ...
                        break;
                    case 'shipping':
                        return (window.webposConfig['tax/cart_display/shipping'] == EXCLUDE) ? false : true;
                        break;
                }
            }
            return true;
        },
        isSalesDisplayIncludeTax: function (type) {
            if (type) {
                var EXCLUDE = '1';
                var INCLUDE = '2';
                var BOTH = '3';
                switch (type) {
                    case 'price':
                        return (window.webposConfig['tax/sales_display/price'] == EXCLUDE) ? false : true;
                        break;
                    case 'subtotal':
                        return (window.webposConfig['tax/sales_display/subtotal'] == EXCLUDE) ? false : true;
                        break;
                    case 'shipping':
                        return (window.webposConfig['tax/sales_display/shipping'] == EXCLUDE) ? false : true;
                        break;
                }
            }
            return true;
        ...
        getQuoteInitParams: function () {
            ...
            return {
                ...
                custom_method_1price: DataManager.getData(self.KEY.CUSTOM_METHOD_1PRICE),
