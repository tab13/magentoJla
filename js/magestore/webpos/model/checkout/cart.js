    ...
    function ($, ko, Items, Totals, Event, DataManager, CartResource, TaxCalculator, poleHelper, Helper, ProductFactory) {
        ...
        var CartModel = {
            ...
            KEY: {
                ...
                CUSTOM_METHOD_1PRICE: "custom_method_1price"
            ...
            collectTaxRate: function(data){
                ...
                switch(calculateTaxBaseOn){
                    ...
                    case 'billing':
                        ...
                        break;
                    case 'origin':
                        data.tax_rates = TaxCalculator.getOriginRate(data.tax_class_id, this.customerGroup());
                        break;
                }
            ...
            reCollectTaxRate: function(){
                ...
                if(Items.items().length > 0){
                    ...
                    ko.utils.arrayForEach(Items.items(), function(item) {
                        ...
                        if(calculateTaxBaseOn == "origin"){
                            taxrate = taxOriginRate;
                        }
            ...
            removeItemOnline: function(itemId){
                ...
                self.loading(true);
                var apiRequest = $.Deferred();
                window.isRemovingCartItemOnline = true;
                ...
                apiRequest.done(
                    function (response) {
                        ...
                        window.isRemovingCartItemOnline = false;
                    }
                ).always(function(){
                    self.loading(false);
                    poleHelper('', 'Total: ' +
