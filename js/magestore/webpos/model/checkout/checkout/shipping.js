...
define(
    ...
    function ($, ko, Event, DataManager, Helper, CheckoutModel, CartModel, Items, PriceHelper) {
        "use strict";
        var ShippingModel = {
            /**
             * Shipping methods
            ...
            // CUSTOMIZE edit custom method shipping US13
            priceEditAble: ko.observable(false),
            // CUSTOMIZE edit custom method shipping end US13
            /**
             * Initialize
             */
            ...
            initShippingMethod: function(){
                ...
                // CUSTOMIZE store credit US13
                if (method && method === 'webpos_shipping_cs1') {
                    self.priceEditAble(true);
                } else {
                    self.priceEditAble(false);
                }
                // CUSTOMIZE store credit end US13
                if(method){
