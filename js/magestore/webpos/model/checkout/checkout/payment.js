...
define(
    ...
    function ($, ko, Event, DataManager, CartModel, CheckoutModel, PriceHelper, Helper, Totals, CreditCard) {
        ...
        var PaymentModel = {
            ...
            WEBPOS_PAYMENTS:['cashforpos','pendingforpos','ccforpos','codforpos','cp1forpos','cp2forpos'],// CUSTOMIZE pending payment US15,16
            MULTIABLE_PAYMENTS:['cashforpos','pendingforpos','ccforpos','codforpos','cp1forpos','cp2forpos', 'pay_payment_instore'],// CUSTOMIZE pending payment US15,16
